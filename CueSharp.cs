...
namespace CueSharp
{
    ...
    public class CueSheet
    {
        ...
        [Description("Set the length of the last track, e.g. set this property to 4 and listen using foobar2000 to determine exact value for the next iteration.")]
        public int LastTrackMinutes { get; set; }
        [Description("Set the length of the last track")]
        public int LastTrackSeconds { get; set; }
        [Description("Set the length of the last track")]
        public int LastTrackFrames { get; set; }
        ...
        public CueSheet(string cuefilename)
            : this(cuefilename, Encoding.Default)
        {
        }
        ...
        public void SaveCue(string filename, Encoding encoding)
        {
            ...
            tw.WriteLine(this.ToOutputString());
        ...
        public string ToOutputString()
        {
            ...
            {
                output.Append("FILE \"" + m_CDTextFile.Trim() + "\"" + Environment.NewLine);
            }
